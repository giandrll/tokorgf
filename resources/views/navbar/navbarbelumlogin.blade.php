...
.nav-item.active[href*="/"] .icon-container::before {
    background-color: rgba(76, 175, 80, 0.2);
}

/* Product Icon Active */
.nav-item.active[href*="produksebelumlogin"] {
    color: #2196F3;
}

.nav-item.active[href*="produksebelumlogin"] .icon-container::before {
...
<nav class="navbar">
    <div class="navbar-container">
        <div class="navbar-center">
            ...
            <a href="/produksebelumlogin" class="nav-item {{ Request::is('produksebelumlogin') ? 'active' : '' }}">
                <div class="icon-container">
                    <i class="fas fa-cubes"></i>
                </div>
                <span>Product</span>
            </a>
            <a href=javascript:void(0)" class="nav-item" onclick="checkabout()" class="nav-item ">
                <div class="icon-container">
